...
hgeDistortionMesh* CALL hgeDistortionMeshCreateWithColumns(int cols, int rows)
{
	return new hgeDistortionMesh(cols, rows);
}

hgeDistortionMesh* CALL hgeDistortionMeshCreateFromDistortionMesh(const hgeDistortionMesh &dm)
{
	return new hgeDistortionMesh(dm);
}

void CALL hgeDistortionMeshDestroy(hgeDistortionMesh *dm)
{
	delete dm;
}
