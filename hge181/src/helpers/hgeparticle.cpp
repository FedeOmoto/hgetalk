...
hgeParticleSystem* CALL hgeParticleSystemCreateFromFile(const char *filename, hgeSprite *sprite)
{
	return new hgeParticleSystem(filename, sprite);
}

hgeParticleSystem* CALL hgeParticleSystemCreateFromParticleSystemInfo(hgeParticleSystemInfo *psi)
{
	return new hgeParticleSystem(psi);
}

hgeParticleSystem* CALL hgeParticleSystemCreateFromParticleSystem(const hgeParticleSystem &ps)
{
	return new hgeParticleSystem(ps);
}

void CALL hgeParticleSystemDestroy(hgeParticleSystem *ps)
{
	delete ps;
}
