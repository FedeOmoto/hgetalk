...
hgeColorRGB* CALL hgeColorRGBCreateFromRGBA(float _r, float _g, float _b, float _a)
{
	return new hgeColorRGB(_r, _g, _b, _a);
}

hgeColorRGB* CALL hgeColorRGBCreateFromInteger(DWORD col)
{
	return new hgeColorRGB(col);
}

hgeColorRGB* CALL hgeColorRGBCreate()
{
	return new hgeColorRGB();
}

void CALL hgeColorRGBDestroy(hgeColorRGB *col)
{
	delete col;
}
